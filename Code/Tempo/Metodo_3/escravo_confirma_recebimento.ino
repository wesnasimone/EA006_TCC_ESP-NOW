...
Utilizando o método 3, o escravo mede o tempo através
...
void OnDataRecv(const uint8_t *mac, const uint8_t *incomingData, int len) {
  ...
  if((printa_uma_vez == 1)){
    ...
    //é necessário informar ao mestre que o dado chegou
  ...
  count = count + 1;      //incrementa variavel que está sincronizada com o número do pacote recebido
  dataSend.a[0] = 1;      //sinaliza o recebimento do dado
