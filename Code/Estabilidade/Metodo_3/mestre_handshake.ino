...
#							                                          #
#	                  Mestre - ESP-NOW                    #
#            Verifica Estabilidade - Método 3		        #
#							                                          #
#	     	                                                #
...
Utilizando o método 3, o mestre só envia o próximo pacote se
receber uma confirmação do escravo.
...
void loop() {   
    ...
    while(c<= pacotes){                                         //envia 1000 pacotes de 250 bytes
        if((flag_confirmacao == 1) && (c >= (c_old+1))){        //se o dado chegou até o escravo e o número do pacote atual for igual ao pacote antigo mais 1
